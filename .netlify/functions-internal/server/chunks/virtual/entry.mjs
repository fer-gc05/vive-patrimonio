...
import { c as createError, $ as $fetch, l as hasProtocol, f as joinURL, m as defu, w as withQuery, s as sanitizeStatusCode, p as parseURL, e as encodePath, n as decodePath, o as isScriptProtocol } from '../nitro/nitro.mjs';
...
var namedMiddleware = { auth: () => import('../build/auth-D-cD5pAX.mjs') };
//#endregion
//#region app/pages/admin/dishes.vue?macro=true&vue&type=script&setup=true&lang.ts
var __nuxt_page_meta$6 = { layout: "admin" };
//#endregion
//#region app/pages/admin/drinks.vue?macro=true&vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/pages/admin/login.vue?macro=true&vue&type=script&setup=true&lang.ts
var __nuxt_page_meta$3 = { layout: false };
//#endregion
//#region app/pages/admin/settings.vue?macro=true&vue&type=script&setup=true&lang.ts
var __nuxt_page_meta$2 = { layout: "admin" };
//#endregion
//#region app/pages/admin/tours.vue?macro=true&vue&type=script&setup=true&lang.ts
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		component: () => import('../build/dishes-yTyzdH-o.mjs')
	},
	{
		name: "admin-drinks",
		path: "/admin/drinks",
		...
		component: () => import('../build/drinks-DmjgiJYy.mjs')
	},
	{
		name: "admin-gallery",
		path: "/admin/gallery",
		...
		component: () => import('../build/gallery-CiUrtSNW.mjs')
	},
	{
		name: "admin-login",
		path: "/admin/login",
		meta: __nuxt_page_meta$3 || {},
		component: () => import('../build/login-BEIQLjbh.mjs')
	},
	{
		name: "admin-settings",
		path: "/admin/settings",
		...
		component: () => import('../build/settings-BxQeO6fv.mjs')
	},
	{
		name: "admin-tours",
		path: "/admin/tours",
		...
		component: () => import('../build/tours-BtWztLWr.mjs')
	},
	{
		name: "admin",
		path: "/admin",
		...
		component: () => import('../build/admin-EYbn2p3e.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-DauJ9QRb.mjs')
	}
];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = {
	admin: defineAsyncComponent(() => import('../build/admin-76cQ6JKK.mjs').then((m) => m.default || m)),
	default: defineAsyncComponent(() => import('../build/default-D4WxuaWN.mjs').then((m) => m.default || m))
};
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-BNovkdx2.mjs'));
...
export { _plugin_vue_export_helper_default as _, useSeoMeta$1 as a, useRuntimeConfig as b, useHead$1 as c, defineNuxtRouteMiddleware as d, executeAsync as e, encodeRoutePath as f, useNuxtApp as g, nuxtLinkDefaults as h, entry as i, navigateTo as n, resolveRouteObject as r, useRouter as u };
