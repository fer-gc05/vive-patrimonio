...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "1fe343ec-602a-4eae-b689-7de2ef5d5575",
  ...
  "public": {
    "supabaseUrl": "https://mqcsmlyzfzgitczsxlrc.supabase.co",
    "supabaseKey": "sb_publishable_VVUvPXcIdsl4hv-0n0y5Lw_kbALnByY"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const _lazy_HWyH8s = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_HWyH8s, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HWyH8s, lazy: true, middleware: false, method: undefined }
];
